    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener buttonClickListener = view -> {
            if (view.getId() == R.id.homeButton) {
                startActivity(new Intent(TutorialPage.this, MainActivity.class));
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
            } else if (view.getId() == R.id.scanButton) {
                startActivity(new Intent(TutorialPage.this, HelmPage.class));
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
            } else if (view.getId() == R.id.tutorialButton) {
                startActivity(new Intent(TutorialPage.this, TutorialPage.class));
                overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
            }
        };
